...
<div class="flex-col w-full py-4 mx-auto bg-white dark:bg-gray-800 border-b-2 border-r-2 border-gray-200 sm:px-4 sm:py-4 md:px-4 sm:rounded-lg sm:shadow-sm md:w-2/3">
        <Comment />
...
<!--
<section class="relative flex items-center justify-center w-full min-h-screen antialiased bg-white bg-gray-100 min-w-screen">
