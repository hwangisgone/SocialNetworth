...
<div class="mx-auto w-11 h-11 xl:w-auto flex items-center justify-center bg-primary hover:bg-blue-500 py-3 rounded-full text-primary-content font-bold font-sm transition duration-350 ease-in-out mb-10" onclick="my_modal_1.showModal()">
