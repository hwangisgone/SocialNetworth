	...
	<div class="flex flex-shrink-0 p-4 pb-0">
		<a href="#" class="flex-shrink-0 group block"
			><div class="flex items-top">
				...
				<div class="ml-3 flex gap-1 items-center font-medium text-base dark:text-white">
					...
					<span class="text-sm leading-5  group-hover:text-gray-300 transition ease-in-out duration-150"
							>@{postUser.nameTag}</span>
					<span>·</span>
					<span class="text-sm">{toDisplayDate(post.timePosted)}</span>
				</div>
			</div></a
		>
	</div>
