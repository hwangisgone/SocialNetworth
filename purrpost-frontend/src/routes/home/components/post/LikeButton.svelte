...
{#if liked}
<button  on:click={unlikePost}>
<div class="flex-1 flex items-center text-xs text-red-600 dark:text-red-600">
...
<div class="flex-1 flex items-center text-gray-800 dark:text-white text-xs text-gray-400 hover:text-red-600 dark:hover:text-red-600 transition duration-350 ease-in-out">
	<svg class="w-5 h-5 mr-2" viewBox="-1.2 -1.2 26.40 26.40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
